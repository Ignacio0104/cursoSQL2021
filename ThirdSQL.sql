...
select ciudad,count(*) from visitantes group by ciudad; #Agrupa por el argumento indicado
...
select distinct proveedor  from productos; #Omite los valores repetidos
select distinct proveedor from productos group by proveedor;
